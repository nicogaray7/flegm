  ...
  return (
    <form action={formAction} className="mt-2 space-y-2">
      ...
      <textarea
        ...
        className="w-full rounded border border-slate-200 px-3 py-2 text-sm text-slate-900 placeholder-slate-400 focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500"
        required
      />
      {state?.error && (
